...
export default class RegistrationForm {
    ...
    usernameHandler() {
        ...
        this.username.timer = setTimeout(() => this.usernameAfterDelay(), 600)
    }
    ...
    passwordHandler() {
        ...
        this.password.timer = setTimeout(() => this.passwordAfterDelay(), 600)
    }
    ...
    usernameImmediately() {
        ...
        if (this.username.value.length > 12) {
            this.showValidationError(this.username, "Username cannot exceed 12 characters")
        }
